  ...
  return (
    <div className="max-w-5xl mx-auto px-3 py-8 text-gray-800">
      <div className="mx-auto text-center mb-8">
        <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-gray-900">Sistema de monitoreo de calidad de ríos</h2>
      </div>
      ...
      <div className="xl:mt-15 lg:mt-12 sm:mt-10 mt-7">
        <h3 className="lg:text-3xl sm:text-2xl text-lg lg:mb-3 mb-1 font-semibold">Accesos rápidos</h3>
        <ul className="list-disc max-w-[95%] m-auto">
          <li>Consulta de datos en tiempo real. <Link href="/monitoreo"><img src="/img/redirect.svg" width={20} height={20} alt="redirect" className="inline bg-sky-600 hover:bg-sky-400 rounded-sm p-px border" /></Link></li>
          <li>Conocé más sobre el proyecto. <Link href="/proyecto"><img src="/img/redirect.svg" width={20} height={20} alt="redirect" className="inline bg-sky-600 hover:bg-sky-400 rounded-sm p-px border" /></Link></li>
          <li>Equipo de investigación. <Link href="/equipo"><img src="/img/redirect.svg" width={20} height={20} alt="redirect" className="inline bg-sky-600 hover:bg-sky-400 rounded-sm p-px border" /></Link></li>
          <li>Documentación técnica de la API pública. <Link href="/api-docs"><img src="/img/redirect.svg" width={20} height={20} alt="redirect" className="inline bg-sky-600 hover:bg-sky-400 rounded-sm p-px border" /></Link></li>
        </ul>
      </div>
