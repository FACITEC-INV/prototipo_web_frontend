...
import { $isLoading } from "@/stores/dispositivos/formStatus";
import { handelSearch, handleDelete, handleEdit } from "@/stores/dispositivos/tableActions";
import { $searchTerm, $tableData } from "@/stores/dispositivos/tableStatus";
      ...
      <div className="card-body">
        ...
        <div className="flex">
          <div className="basis-2/3">
            <h2 className="card-title justify-center">Dispositivos registrados</h2>
          </div>
          <div className="basis-2/3">
            ...
            <tbody>
              {
                data.map((i, index) => (
                  <tr key={i.id} className="hover:bg-base-300">
                    ...
                    <td>{i.rio}</td>
                    <td>{i.ubicacion}</td>
                    <td>{i.intervaloActualizacion}</td>
                    <td>{i.ultimaConexion ? i.ultimaConexion : '---'}</td>
                    <td>
